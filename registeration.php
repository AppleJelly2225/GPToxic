...
<html>
    ...
    <body style= "background-image: linear-gradient(to right, #448b33, #232920);">
		...
		<div class="OtherBody" style="background-color: #D6EF9F;">
			<form action="register_user.php" method="post" style="padding: 50px">
			<h1>Register</h1>
            (* = required)
			<br><br>
			Username*: <input type="text" name="username" required style>
			<br><br>
            Name* (first): <input type="text" name="name" required>
			<br><br>
			Password*: <input type="text" name="password" required>
			<!-- <br><br>
			Comfirm Password*: <input type="text" name="password" required> -->
            <br><br>
